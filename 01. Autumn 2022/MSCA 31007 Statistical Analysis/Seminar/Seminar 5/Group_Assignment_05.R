...
dataPath <- "C:/Users/Administrator/Downloads/MScA 31007 Statistical Analysis/Seminar 5"
test_data <- read.table(paste(dataPath,'test_sample_1.csv',sep = '/'), header=TRUE)
