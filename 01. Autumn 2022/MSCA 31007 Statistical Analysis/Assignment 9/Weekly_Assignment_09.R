dataPath <- "C:/Users/Administrator/Downloads/MScA 31007 Statistical Analysis/Assignment 9"
#Project.Data <- read.csv(file="C:/Users/Administrator/Downloads/MScA 31007 Statistical Analysis/Assignment 9/PCA_ExampleData.csv",header=TRUE,sep=",")
...
new_lm <- cbind(Project.Data[1], Project.Data.PCA1$x[,1:3])
