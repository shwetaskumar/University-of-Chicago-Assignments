...
model = load_model('BMI/best_bmi_model_v3_3.h5',compile=False)
age_model = load_model('BMI/best_age_model_v1_2.h5',compile=False)
gender_model = load_model('BMI/best_gender_model_v1_0.h5')
